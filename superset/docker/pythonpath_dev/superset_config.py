...
# Increase timeout for dashboards and SQL Lab queries
...
# Allow cross-origin requests from your Flask app
ENABLE_CORS = True
CORS_OPTIONS = {
...
GUEST_TOKEN_JWT_SECRET = "my-very-strong-secret-12345"
...
# Optional: disable Celery if you don't need it
CELERY_CONFIG = None

# Ensure Superset generates correct links for embedded charts
